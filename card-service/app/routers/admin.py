"""
Admin router for the Card Service.
...
Note: Card Service has its own copy of LanguageContent, seeded independently
from the Challenge Service. Both use the same finnish_seed.py source data.
"""
